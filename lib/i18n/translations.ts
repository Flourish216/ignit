...
export const translations = {
  en: {
    nav: { home: 'Home', explore: 'Explore', teams: 'Teams', newProject: 'New Project', signIn: 'Sign In', getStarted: 'Get Started', profile: 'Profile', myTeams: 'My Teams', messages: 'Messages', searchProjects: 'Search projects...', signOut: 'Sign Out' },
  ...
  zh: {
    nav: { home: '首页', explore: '探索', teams: '团队', newProject: '新建项目', signIn: '登录', getStarted: '开始使用', profile: '个人资料', myTeams: '我的团队', messages: '消息', searchProjects: '搜索项目...', signOut: '退出登录' },
